      ...
      data: [
        {
          ...
          covers: ['chapter:7'],
          recipientAddresses: ['chapter-7-oversight@example.com'],
        ...
        },
        {
          ...
          covers: ['chapter:11'],
          recipientAddresses: ['chapter-11-oversight@example.com'],
        ...
        },
        {
          ...
          covers: ['chapter:12'],
          recipientAddresses: ['chapter-12-oversight@example.com'],
        ...
        },
        {
          ...
          covers: ['chapter:13'],
          recipientAddresses: ['chapter-13-oversight@example.com'],
        ...
        },
        {
          ...
          recipientAddresses: ['subv@example.com'],
        ...
        },
        {
          ...
          recipientAddresses: ['zoom-341@example.com'],
