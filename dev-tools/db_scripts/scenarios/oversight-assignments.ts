...
export async function generate(ctx: SeedContext): Promise<SeedOperation[]> {
  ...
  return [
    ...
    // Trustee appointments — makes all oversight trustees appear active in the trustee list
    {
      db: 'cams',
      collectionOrTable: 'trustee-appointments',
      data: [
        {
          id: 'seed-appt-oversight-attorney',
        ...
        {
          id: 'seed-appt-oversight-auditor',
          documentType: 'TRUSTEE_APPOINTMENT',
          trusteeId: TRUSTEE_ID_AUDITOR,
          chapter: '7',
          appointmentType: 'panel',
        ...
        {
          id: 'seed-appt-oversight-paralegal',
          documentType: 'TRUSTEE_APPOINTMENT',
          trusteeId: TRUSTEE_ID_PARALEGAL,
          chapter: '7',
          appointmentType: 'panel',
