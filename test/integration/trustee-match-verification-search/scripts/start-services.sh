#!/bin/bash
# Start local infrastructure for trustee-match-verification-search integration tests.
...
echo ""
echo "Copy .env.template to .env.local and set COSMOS_DATABASE_NAME."
