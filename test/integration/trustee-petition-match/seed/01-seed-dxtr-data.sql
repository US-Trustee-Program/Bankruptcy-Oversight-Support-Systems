...
-- Appointment transaction: TX_TYPE='A', TX_CODE='TR'. REC packs aptDate (YYMMDD)
-- at position 24-29.
INSERT INTO dbo.AO_TX (CS_CASEID, COURT_ID, TX_TYPE, TX_CODE, TX_DATE, REC)
VALUES (
  '999999001', '0208', 'A', 'TR', '2026-06-01T00:00:00',
  STUFF(REPLICATE(' ', 237), 24, 6, '260601')
);
GO

-- Petition transaction: TX_TYPE='1', TX_CODE='1'. REC packs aptDate (YYMMDD)
-- at position 91-96.
INSERT INTO dbo.AO_TX (CS_CASEID, COURT_ID, TX_TYPE, TX_CODE, TX_DATE, REC)
VALUES (
  '999999001', '0208', '1', '1', '2026-03-01T00:00:00',
  STUFF(REPLICATE(' ', 237), 91, 6, '260301')
);
GO
