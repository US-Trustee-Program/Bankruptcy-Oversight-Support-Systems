/**
 * Check CHAPTER_DETAILS (appointments) table structure and data
 *
 * Usage (from repo root):
 *   npx tsx --tsconfig backend/tsconfig.json test/migration/trustee/scripts/check-appointments.ts
 */
