...
/**
 * flushQueues intent: drain the failure/DLQ queues to JSONL blobs (bookend
 * reporting / inspection). This is deliberately NOT a full-queue dump: the
 * START and PAGE queues are transient work queues for a healthy running
