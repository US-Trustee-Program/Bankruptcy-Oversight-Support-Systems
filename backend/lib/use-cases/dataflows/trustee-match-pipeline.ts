 ...
 */
export type Disqualifier = { scorer: string; reason: string; evidence: Record<string, unknown> };
 ...
 * another stage already proposed never resets its accumulated score history. */
