...
function diffFields(
  ...
  if (existingTprCompletionYear !== incomingTprCompletionYear) {
    if (existingTprCompletionYear !== null) before.tprCompletionYear = existingTprCompletionYear;
    if (incomingTprCompletionYear !== null) after.tprCompletionYear = incomingTprCompletionYear;
  }
  return { before, after };
}
