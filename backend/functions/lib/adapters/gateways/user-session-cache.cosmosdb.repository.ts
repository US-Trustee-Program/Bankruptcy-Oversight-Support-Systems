...
//       ttl,
//     };
//     return toCamsSession(await this.repo.create(context, cached));
//   }
// }
//
...
// }
export class UserSessionCacheCosmosDbRepository {
  constructor(..._ignore) {}

  get(..._ignore): Promise<CamsSession> {
    throw new Error('Not Implemented');
  }
  put(..._ignore): Promise<CamsSession> {
    throw new Error('Not Implemented');
  }
}
