...
export class MockPacerApiGateway implements PacerGatewayInterface{
  ...
  private setUpChapter15TestCaseList() {
    ...
    oldCases.push(
    {
      ...
      "dateFiled": new Date(today.getFullYear()-4,today.getMonth()-10, today.getDate()).toISOString().split('T')[0],
    ...
    },
    {
      ...
      "dateFiled": new Date(today.getFullYear(),today.getMonth()-7, today.getDate()).toISOString().split('T')[0],
    ...
    },
    {
      ...
      "dateFiled": new Date(today.getFullYear()-10,today.getMonth(), today.getDate()).toISOString().split('T')[0],
    ...
    newCases.push(
      {
        ...
        // "caseType": "bk",
        "caseTitle": "Heather Anne Real",
        "dateFiled": new Date(today.getFullYear(),today.getMonth()-1, today.getDate()).toISOString().split('T')[0],
        // "dateDischarged": "2007-10-26",
        // "bankruptcyChapter": "15",
        // "jointBankruptcyFlag": "n",
        // "jurisdictionType": "Bankruptcy",
      ...
      },
      {
        ...
        "dateFiled": new Date(today.getFullYear(),today.getMonth()-3, today.getDate()).toISOString().split('T')[0],
        // "dateDischarged": "2007-10-26",
        // "bankruptcyChapter": "15",
        // "jointBankruptcyFlag": "n",
        // "jurisdictionType": "Bankruptcy",
      ...
      },
      {
        ...
        "dateFiled": new Date(today.getFullYear(),today.getMonth()-2, today.getDate()).toISOString().split('T')[0],
        // "dateDischarged": "2007-10-26",
        // "bankruptcyChapter": "15",
        // "jointBankruptcyFlag": "n",
        // "jurisdictionType": "Bankruptcy",
