...
while [[ $# -gt 0 ]]; do
    ...
    --createAlerts)
        ...
        shift 2
        ;;
    --createMainSqlPrivateEndpoint)
        inputParams+=("${1}")
        create_main_sql_private_endpoint_param="createMainSqlPrivateEndpoint=${2}"
        deployment_parameters="${deployment_parameters} ${create_main_sql_private_endpoint_param}"
        shift 2
        ;;
    --actionGroupName)
        inputParams+=("${1}")
