...
param senderAddressSecretName string
...
module acsConnectionStringSecret '../keyvault/keyvault-secret.bicep' = {
  ...
  params: {
    ...
    secretName: connectionStringSecretName // pragma: allowlist secret
...
module acsSenderAddressSecret '../keyvault/keyvault-secret.bicep' = {
  ...
  params: {
    keyVaultName: kvAppConfigName
    secretName: senderAddressSecretName // pragma: allowlist secret
