...
param resourceGroupName string = 'bankruptcy-oversight-support-systems'
@description('CosmosDb account name')
param accountName string = 'cosmos-mongo-ustp-cams-dev'
...
param keyVaultName string = 'kv-ustp-cams-dev'

param kvResourceGroup string = 'bankruptcy-oversight-support-systems'
