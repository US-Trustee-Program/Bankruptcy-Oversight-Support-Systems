  ...
  describe('isString', () => {
    const testCases = [
      ...
      },
      {
        ...
        value: 123,
        expected: { valid: false, reason: 'Must be a string' },
      },
      {
  ...
  describe('matches', () => {
    const testCases = [
      ...
      },
      {
        ...
        regex: /^[a-z]+$/,
        value: 'Hello123',
        expected: { valid: false, reason: 'Must match the pattern /^[a-z]+$/' },
      },
      {
        ...
        value: 'abc',
        expected: { valid: false, reason: 'Must be only digits' },
      },
      {
      ...
      },
      {
        ...
        regex: /^.+$/,
        value: '',
        expected: { valid: false, reason: 'Must match the pattern /^.+$/' },
      },
      {
        description: 'should return invalid for non-string values',
        regex: /^[a-z]+$/,
  ...
  describe('isPhoneNumber', () => {
    const testCases = [
      ...
      },
      {
        ...
        value: '123456789',
        expected: { valid: false, reason: 'Must be a valid phone number' },
      },
      {
  ...
  describe('isInSet', () => {
    const testCases = [
      ...
      },
      {
        ...
        set: ['red', 'green', 'blue'],
        value: 'yellow',
        expected: { valid: false, reason: 'Must be one of red, green, blue' },
      },
      {
      ...
      },
      {
        ...
        value: 'd',
        expected: { valid: false, reason: 'Must be a valid option' },
      },
      {
