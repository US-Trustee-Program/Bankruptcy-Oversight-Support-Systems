import UspsStatesComboBox from './UspsStatesComboBox';
...
describe('UspsStatesComboBox', () => {
  ...
  test('should render ComboBox with USPS states options and correct labels', () => {
    ...
    render(<UspsStatesComboBox {...props} />);
    ...
    expect(comboBoxProps.options).toHaveLength(uspsStatesFull.length);

    // Check first few options have correct format
    const firstState = uspsStatesFull[0];
