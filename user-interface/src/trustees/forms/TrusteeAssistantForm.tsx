...
import { TrusteeInput, TrusteeAssistant, TrusteeAssistantFormData } from '@common/cams/trustees';
import { trusteeAssistantSpec } from '@common/cams/trustees-validators';
