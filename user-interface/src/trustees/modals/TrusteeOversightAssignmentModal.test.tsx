...
describe('TrusteeOversightAssignmentModal', () => {
  ...
  describe('Attorney Role', () => {
    ...
    test('should load attorneys when modal opens', async () => {
      ...
      await waitFor(() => {
        expect(mockApiMethods.getStaff).toHaveBeenCalledTimes(1);
      });
    });
    ...
    test('should display ComboBox for attorney selection', async () => {
      ...
      act(() => ref.current!.show());
      await waitFor(() => expect(mockApiMethods.getStaff).toHaveBeenCalled());
    ...
    test('should handle loading error', async () => {
      mockApiMethods.getStaff.mockRejectedValueOnce(new Error('API Error'));
    ...
    test('should show loading spinner while fetching staff', async () => {
      ...
      mockApiMethods.getStaff.mockReturnValueOnce(loadingPromise);
