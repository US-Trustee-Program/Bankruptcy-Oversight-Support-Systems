...
```mermaidgraph TB
  ...
  subgraph diagram [System Landscape]
    ...
    4("<div style='font-weight: bold'>CAMS</div><div style='font-size: 70%; margin-top: 0px'>[Software System]</div><div style='font-size: 80%; margin-top:10px'>CAse Management System</div>")
    ...
    3-. "<div>Reviews, approves, and<br />rejects case events</div><div style='font-size: 70%'></div>" .->4
  end
```
